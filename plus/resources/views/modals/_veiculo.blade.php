<div class="modal fade" id="modal_novo_veiculo" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row g-2">
                    ...
                    <div class="col-md-2">
                        ...
                        ->attrs(['data-mask' => '000000000000', 'class' => 'ignore'])
                        !!}
                    </div>

                    <div class="col-md-2">
                        {!!Form::text('taf', 'TAF')
                        ->attrs(['data-mask' => '00000000000000', 'class' => 'ignore'])
                        !!}
                    </div>

                    <div class="col-md-3">
                        {!!Form::text('numero_registro_estadual', 'Nº registro estadual')
                        ->attrs(['data-mask' => '0000000000000000000000000', 'class' => 'ignore'])
                        !!}
                    </div>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-success btn-store-veiculo">Salvar</button>
            </div>
        </div>
    </div>
</div>