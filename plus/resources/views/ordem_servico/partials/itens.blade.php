<tr class="dynamic-form">
    ...
    <td>
        <input style="width: 150px;" value="{{ __moeda($prod->valor) }}" class="form-control moeda valor_unit" type="tel" name="valor_unitario[]" id="inp-valor_unitario">
    </td>
    <td>
        <input style="width: 150px;" value="{{ __moeda($prod->subtotal) }}" class="form-control moeda sub_total" type="tel" name="sub_total[]" id="inp-subtotal">
    </td>
    <td>
