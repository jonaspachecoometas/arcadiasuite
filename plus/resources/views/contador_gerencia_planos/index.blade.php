        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="col-lg-12">
                    ...
                    <div class="row mt-3">
                        <div class="col-md-3">
                            {!!Form::select('_empresa', 'Pesquisar por empresa', ['' => 'Selecione'] + $empresas->pluck('nome', 'id')->all())
                        ...
                        <div class="col-md-3 text-left ">
                            ...
                            <a id="clear-filter" class="btn btn-danger" href="{{ route('contador-gerencia.index') }}"><i class="ri-eraser-fill"></i>Limpar</a>
                        </div>
                    </div>
                    {!!Form::close()!!}
                </div>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <form action="{{ route('contador-gerencia.destroy', $item->id) }}" method="post" id="form-{{$item->id}}">
                                            @method('delete')
                                            @csrf

                                            <a class="btn btn-warning btn-sm text-white" href="{{ route('contador-gerencia.edit', [$item->id]) }}">
...
<div class="modal fade" id="modal-cad" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <form class="modal-content" method="post" action="{{ route('contador-gerencia.store') }}">
            @csrf
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-6">
                        {!!Form::select('empresa_atribuir', 'Empresa', ['' => 'Selecione'] + $empresas->pluck('nome', 'id')->all())
                        ->required()
                        ->attrs(['class' => 'select2'])
                        !!}
                    </div>
